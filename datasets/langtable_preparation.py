...
def process_and_split(dataset, output_dir, tokenizer, max_instruction_length, resize_resolution, valid_ratio, test_ratio, random_seed, t5_encoder):
    ...
    #     save_episode(episode_ids_with_data[episode_id], 'train', episode_id.encode(), output_dir, tokenizer, max_instruction_length, resize_resolution, t5_encoder)
    ...
    #     save_episode(episode_ids_with_data[episode_id], 'valid', episode_id.encode(), output_dir, tokenizer, max_instruction_length, resize_resolution, t5_encoder)
    ...
    #     save_episode(episode_ids_with_data[episode_id], 'test', episode_id.encode(), output_dir, tokenizer, max_instruction_length, resize_resolution, t5_encoder)
