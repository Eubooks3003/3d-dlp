...
# RLBench language-conditioned config for task: meat_off_grill
...
mode_to_args = {
  '16C_dlp': {
    ...
    'override_dataset_path': '/home/ellina/Desktop/data/preprocessed_voxel_tokens_with_keyposes/rlbench_meat_off_grill/meat_off_grill.pkl',
...
base = {
    'diffusion': {
        ...
        # serialization
        'logbase': logbase,
        'prefix': 'diffusion/rlbench_meat_off_grill_keypose/',
    ...
    'plan': {
        ...
        'loadbase': None,
        'logbase': logbase,
        'prefix': 'plans/rlbench_meat_off_grill_keypose/',
        'exp_name': watch(args_to_watch),
        'vis_freq': 10,
        'max_render': 8,
